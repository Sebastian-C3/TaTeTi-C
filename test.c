...
/*
	Descripcion: recibe "nombreJugadorA"
	Pre: "nombreJugadorA"correctamente definido y asignado
	Post: asigna el nuevo nombre al jugador A
*/
void recibirNombreJugadorA(char nombreJugadorA[MAX_NOMBRE]){
	printf("Ingrese nombre de jugador A\n");
	scanf(" %s", nombreJugadorA);
}

/*
	Descripcion: recibe "nombreJugadorB"
	Pre: "nombreJugadorA"correctamente definido y asignado
	Post: asigna el nuevo nombre al jugador B
*/
void recibirNombreJugadorB(char nombreJugadorB[MAX_NOMBRE]){
...
void recibirNombresJugadores(char nombreJugadorA[MAX_NOMBRE], char nombreJugadorB[MAX_NOMBRE], int cantJugadores){
	...
	if(cantJugadores == CANT_JUGADORES_UNO){
...
void configInicialJuego(){
	...
	presentarJuego();//al presentar diferenciar si 1 o 2 jugadores			
	//consultar cantidad de jugadores
